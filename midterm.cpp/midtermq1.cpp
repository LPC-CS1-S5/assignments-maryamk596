...
// it has 18 iterations. 
// it works such as, start print when both "i" and "j" are at zero. 
...
// print 2 for i and 2 for j and loop terminate because j can not become less than i. 